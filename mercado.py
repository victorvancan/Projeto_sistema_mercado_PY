...
def listar_produto() -> None:
    if len(produtos) > 0:
        ...
        print('Ainda não existem produtos cadstrados')
        sleep(2)
        menu()
    ...
    if len(carrinho) > 0:
        ...
        for item in carrinho:
            for dados in item.items():
                print(dados[0])
                print(f'quantidae: {dados[1]}')
                print('----------------------')
                sleep(1)
    else:
        print('Ainda não existem produtos no carrrinho.')
    sleep(2)
    menu()
